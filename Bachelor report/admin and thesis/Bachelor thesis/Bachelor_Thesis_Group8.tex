...
\makenoidxglossaries % builds the glossary/abbreviation lists from normal LaTeX passes (no external makeglossaries tool needed)
...
\noindent \textbf{\Large Visualisation of Automatic Identification System Messages for the Norwegian Coastal Administration} \\
\vspace{0.5cm}

\noindent {\large A more secure ocean for the norwegian people} \\
