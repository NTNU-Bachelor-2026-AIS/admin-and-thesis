...
The use of React with TypeScript enforced stronger type safety than plain React, but introduced an initial learning curve. The group's lack of experience with coding standards for react and typescript, led to development time being spent on learning the basics as well as more advanced tools such as Context, which was ultimately used to simplify the code.  
