...
The performance of the system is highly dependent on hardware specifications, with the GPU having a particularly strong influence. \acrshort{webgl} benefits significantly from more capable \acrshortpl{gpu} (Section~\ref{sec:hardware_acceleration}), meaning that performance is bottlenecked on weaker systems. 
