...
\begin{figure}[H]
  ...
  \caption{Illustration of clustering of data points. Source: https://www.grammarly.com/blog/ai/what-is-clustering/}
  \label{fig:latlong}
\end{figure}


\section{HeatMap}
Heatmaps are used for data visualization, to show relationship between variables, like amount of data points per type, the amount of data has a color leading to a higher concentration of data having a darker color than less concentrated areas of points. This leads to intuitive visualization of data for humans to parse. 
...
Vector tiles are whats used in current times by most web map providers. Vector tiles save geographic data in vector format to show the contents of the map, instead of png images that were used in the past. Vector tiles allow for more styling and customization than the mentioned images, and have lead to smoother usage of web maps, at the cost of more processing power needed.
...
\section{Software principles make subsections i.e cohesion, testing}
lorem ipsum
lorem ipsum
lorem ipsum

\section{Agile Development make subsections i.e issues}
lorem ipsum
lorem ipsum
lorem ipsum
