...
Coupling and cohesion are foundational structured design principles originally introduced by \textcite{stevens_structured_design_1974}  for creating sustainable and scalable code. Coupling refers to how tightly different parts of a software system depend on each other. If parts of the software have high coupling, it creates a "ripple effect" where it becomes harder to make changes to the project without other parts of the project breaking \parencite{stevens_structured_design_1974}. Cohesion, originally defined as "module strength", describes whether parts of the software are closely related and designed to complete a singular task, rather than being unfocused and serving multiple unrelated purposes \parencite{stevens_structured_design_1974}. The goal for coupling and cohesion is to have high cohesion and low coupling, which in turn leads to better-designed, maintainable software \parencite{geeksforgeeks_cohesion_coupling}.
% SUGGESTION — ground this in the upgraded PRIMARY source (Stevens, Myers & Constantine, 1974,
%   "Structured Design", IBM Systems Journal 13(2):115-139):
%   READ: https://doi.org/10.1147/sj.132.0115  (free reprint often on IEEE Xplore, or search
%   "Structured Design 1974 Stevens PDF"). Read the "coupling" section and the "module strength"
%   (= cohesion) section.
%   DRAFT (rewrite in your words; keep your text above): "Coupling and cohesion are foundational
%   structured-design principles introduced by Stevens, Myers and Constantine. Coupling is the degree
%   of interdependence between modules; tightly coupled modules are harder to change in isolation,
%   since a change in one can force changes in others. Cohesion (originally 'module strength') is how
%   strongly the elements within one module belong together and serve a single well-defined purpose.
%   Structured design aims for low coupling and high cohesion, producing software that is easier to
%   understand, test, modify and extend." Citing the 1974 origin reads far stronger than a blog.
...
React is a JavaScript library for building user interfaces through a component based architecture \parencite{stevens_structured_design_1974}. Following the official "Thinking in React" methodology, components are reusable pieces of code that receive data through "props" and combine to define the user interface to be rendered \parencite{react_docs}. React's approach provides scalability, modularity and reusability to projects that implement it. React is commonly paired with TypeScript, TypeScript is a strongly typed superset of JavaScript \parencite{typescript_handbook}. TypeScript adds static types to Javascript, enabling strongly typed React applications, catching errors at compile time, and improving overall type safety \parencite{typescript_handbook}.
