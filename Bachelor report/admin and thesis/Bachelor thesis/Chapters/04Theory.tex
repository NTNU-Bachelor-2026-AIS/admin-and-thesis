...
The Automatic Identification System (AIS) is a system used to transfer information about a ship, including its location and heading, to base stations, satellites and other ships, on coasts around the world. The system is prone to errors due to incorrect configurations, area jamming, or message spoofing. The NCA processes this data to detect errors in AIS messages. In practice, this pipeline identifies millions of anomalous messages per day.
\begin{figure}[H]
    \centering
